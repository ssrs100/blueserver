...
SERVICE_USER=blueserver
SERVICE_GROUP=blueserver
PRODUCT_NAME=blueserver
MODULE_NAME=blueserver
...
getPort()
{
    PORT="`sed '/\"port\"/!d;s/[^0-9]//g' ../conf/blueserver.json`"
}

#get process ip
getIp()
{
    IP="`sed '/\"host\"/!d;s/[^0-9.]//g' ../conf/blueserver.json`"
}
